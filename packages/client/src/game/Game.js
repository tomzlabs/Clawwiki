...
export default function Game() {
    ...
    return (<div style={{ padding: 20 }}>
            ...
            {!hasJoined ? (<div style={{ marginTop: 20 }}>
                    <input placeholder="Agent Name" value={name} onChange={e => setName(e.target.value)} style={{ padding: 5, marginRight: 10 }}/>
            ...
            backgroundSize: 'cover'
                ...
                {Object.values(agents).map((agent) => (<div key={agent.id} style={{
                position: 'absolute',
                ...
                {/* Render Names */}
                {Object.values(agents).map((agent) => (<div key={agent.id + '_label'} style={{
                position: 'absolute',
